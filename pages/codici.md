...
1. [`Neural.`{:.codelink}]({{ site.baseurl }}{%link codici/neural.ipynb %}) Backpropagation in MLP a 3 layer (notebook) [In nbviewer](https://nbviewer.jupyter.org/github/tvml/ml1819/blob/master/codici/neural.ipynb)
